...
from dinosparse.data import build_detection_test_loader
from dinosparse.engine import default_argument_parser
...
Flops and activations are data-dependent, therefore inputs and model weights are needed to count them:
